# Wave11: etiological + paper_cases
...
- 见 [`11-etiological与paper_cases.md`](../11-etiological与paper_cases.md) 与对应 artifact
...
| 类型 | 路径 |
| --- | --- |
| 脚本 | `_analysis/compute_eti_paper.py` |
| Artifact | `artifacts/`（见报告） |
| 报告 | `11-etiological与paper_cases.md` |
...
5. `requesting-code-review` → [`_reviews/wave11-review.md`](../_reviews/wave11-review.md)

## Verify

```bash
cd 00_new_codes/reports/superpowers/_analysis
python compute_eti_paper.py
python verify_reports.py
```

## Expected output

- eti flip=27, paper cases=4 filled
...
| code review | ✅ 见 `_reviews/wave11-review.md` |
