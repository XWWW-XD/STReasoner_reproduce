# Wave18: training trace

**Strict redo session**: 2026-05-30  
**Skills invoked**: brainstorming, explore

## Brainstorming（本波事实）

- 见 [`18-训练与SFT通路深读.md`](../18-训练与SFT通路深读.md) 与对应 artifact
...
5. `requesting-code-review` → [`_reviews/wave18-review.md`](../_reviews/wave18-review.md)
...
| code review | ✅ 见 `_reviews/wave18-review.md` |
