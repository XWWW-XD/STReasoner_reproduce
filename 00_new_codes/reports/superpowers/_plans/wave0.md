# Wave0: SUPERPOWERS-WORKFLOW

**Strict redo session**: 2026-05-30  
**Skills invoked**: using-superpowers, writing-plans

## Brainstorming（本波事实）

- 见 [`SUPERPOWERS-WORKFLOW.md`](../SUPERPOWERS-WORKFLOW.md) 与对应 artifact
...
5. `requesting-code-review` → [`_reviews/wave0-review.md`](../_reviews/wave0-review.md)
...
| code review | ✅ 见 `_reviews/wave0-review.md` |
