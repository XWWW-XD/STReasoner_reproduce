# Wave16: inference trace

**Strict redo session**: 2026-05-30  
**Skills invoked**: explore, verification-before-completion

## Brainstorming（本波事实）

- 见 [`16-inference通路深读.md`](../16-inference通路深读.md) 与对应 artifact
...
5. `requesting-code-review` → [`_reviews/wave16-review.md`](../_reviews/wave16-review.md)
...
- inference_trace.json + path:line claims
...
| code review | ✅ 见 `_reviews/wave16-review.md` |
