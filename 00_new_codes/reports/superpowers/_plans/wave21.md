# Wave21: code × experiment

**Strict redo session**: 2026-05-30  
**Skills invoked**: verification-before-completion, requesting-code-review

## Brainstorming（本波事实）

- 见 [`21-代码与实验异常对照.md`](../21-代码与实验异常对照.md) 与对应 artifact
...
5. `requesting-code-review` → [`_reviews/wave21-review.md`](../_reviews/wave21-review.md)
...
- code_experiment_crosswalk.json (5 rows)
...
| code review | ✅ 见 `_reviews/wave21-review.md` |
