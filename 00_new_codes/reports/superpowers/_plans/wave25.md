...
- 见 [`24-真实不稳定flip账本.md`](../24-真实不稳定flip账本.md) 与对应 artifact
...
| 类型 | 路径 |
| --- | --- |
| 脚本 | `_analysis/compute_wave25_real_flip.py` |
| Artifact | `artifacts/`（见报告） |
| 报告 | `24-真实不稳定flip账本.md` |
...
5. `requesting-code-review` → [`_reviews/wave25-review.md`](../_reviews/wave25-review.md)

## Verify

```bash
cd 00_new_codes/reports/superpowers/_analysis
python compute_wave25_real_flip.py
python verify_reports.py
```

## Expected output

- 173 real flips, 132 mismatch=0
...
| code review | ✅ 见 `_reviews/wave25-review.md` |
