# Wave20: pipeline diff

**Strict redo session**: 2026-05-30  
**Skills invoked**: explore, dispatching-parallel-agents

## Brainstorming（本波事实）

- 见 [`20-官方与复现分叉对照.md`](../20-官方与复现分叉对照.md) 与对应 artifact
...
5. `requesting-code-review` → [`_reviews/wave20-review.md`](../_reviews/wave20-review.md)
...
| code review | ✅ 见 `_reviews/wave20-review.md` |
