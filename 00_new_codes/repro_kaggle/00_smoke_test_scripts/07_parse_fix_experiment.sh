...
run_experiment "A. 基线: max_new_tokens=64, answer_format_prompt=false" \
  env CUDA_VISIBLE_DEVICES=0 python repro_kaggle/00_smoke_test_scripts/05_eval_sttest_tiny.py \
    ...
    --output_path repro_kaggle/outputs/experiment1/parsefix_baseline_predictions.jsonl \
    --summary_path repro_kaggle/outputs/experiment1/parsefix_baseline_summary.json \
    --log_path repro_kaggle/outputs/experiment1/parsefix_baseline_eval.log
...
run_experiment "B. 加长生成: max_new_tokens=256, answer_format_prompt=false" \
  env CUDA_VISIBLE_DEVICES=0 python repro_kaggle/00_smoke_test_scripts/05_eval_sttest_tiny.py \
    ...
    --max_new_tokens 256 \
    --answer_format_prompt false \
    --output_path repro_kaggle/outputs/experiment1/parsefix_longer_predictions.jsonl \
    --summary_path repro_kaggle/outputs/experiment1/parsefix_longer_summary.json \
    --log_path repro_kaggle/outputs/experiment1/parsefix_longer_eval.log
...
run_experiment "C. 强制答案格式: max_new_tokens=256, answer_format_prompt=true" \
  env CUDA_VISIBLE_DEVICES=0 python repro_kaggle/00_smoke_test_scripts/05_eval_sttest_tiny.py \
    ...
    --output_path repro_kaggle/outputs/experiment1/parsefix_forced_predictions.jsonl \
    --summary_path repro_kaggle/outputs/experiment1/parsefix_forced_summary.json \
    --log_path repro_kaggle/outputs/experiment1/parsefix_forced_eval.log
...
echo "解析修复实验完成。报告: repro_kaggle/outputs/experiment1/parse_fix_experiment_report.md"
