...
from cache_config import HF_DATASETS_CACHE_PATH, apply_cache_config
...
DEFAULT_OUTPUT_JSON = "repro_kaggle/outputs/early_smoke_tests/one_sttest_prediction.json"
DEFAULT_OUTPUT_LOG = "repro_kaggle/outputs/early_smoke_tests/run_one_sttest_sample.log"
