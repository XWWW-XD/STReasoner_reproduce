...
from cache_config import HF_DATASETS_CACHE_PATH, TRANSFORMERS_CACHE_PATH, apply_cache_config
...
DEFAULT_OUTPUT_PATH = "repro_kaggle/outputs/early_smoke_tests/sttest_tiny_predictions.jsonl"
DEFAULT_SUMMARY_PATH = "repro_kaggle/outputs/early_smoke_tests/sttest_tiny_summary.json"
DEFAULT_LOG_PATH = "repro_kaggle/outputs/early_smoke_tests/sttest_tiny_eval.log"
SELECTED_INDICES_PATH = "repro_kaggle/outputs/experiment1/compare_single4bit_dualfp16_selected_indices.json"
...
def load_or_select_samples(args: argparse.Namespace, logger: TeeLogger) -> list[tuple[int, dict[str, Any]]]:
    ...
    dataset = load_dataset(DATASET_NAME, DATASET_SUBSET, split="train", cache_dir=HF_DATASETS_CACHE_PATH)
