...
MODEL_PATH=/workspace/output/Qwen3-14B-stage2-only-text  # replace it with your local file path
...
python3 -m src.EasyR1.verl.trainer.main \
    ...
    worker.rollout.n=8 \
    trainer.experiment_name=qwen3_14B_grpo_stage2+3_w_spatial_only_text \
